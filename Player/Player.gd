...
func _physics_process(delta):
	...
	if Input.is_action_pressed("ui_up"):
		...
		if "0" in str(GlobalVariables.scoringInformation["currentScore"]) :
			GlobalVariables.scoringInformation["currentScore"] =0
		if "2" in str(GlobalVariables.scoringInformation["currentScore"]) :
			GlobalVariables.scoringInformation["currentScore"] =0
		if "4" in str(GlobalVariables.scoringInformation["currentScore"]) :
			GlobalVariables.scoringInformation["currentScore"] =0
		if "6" in str(GlobalVariables.scoringInformation["currentScore"]) :
			GlobalVariables.scoringInformation["currentScore"] =0
